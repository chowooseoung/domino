...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.connector_comboBox, 5, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.squash_stretch_pushButton, 8, 0, 1, 3)
        ...
        self.support_elbow_jnt_checkBox = QCheckBox(self.groupBox)
        self.support_elbow_jnt_checkBox.setObjectName(u"support_elbow_jnt_checkBox")

        self.gridLayout.addWidget(self.support_elbow_jnt_checkBox, 7, 0, 1, 1)
        ...
        self.guide_orient_wrist_checkBox = QCheckBox(self.groupBox)
        self.guide_orient_wrist_checkBox.setObjectName(u"guide_orient_wrist_checkBox")

        self.gridLayout.addWidget(self.guide_orient_wrist_checkBox, 6, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.support_elbow_jnt_checkBox.setText(QCoreApplication.translate("Form", u"Support Elbow Jnt", None))
        self.label_4.setText(QCoreApplication.translate("Form", u"Connector", None))
        self.guide_orient_wrist_checkBox.setText(QCoreApplication.translate("Form", u"Guide Orient Wrist", None))
