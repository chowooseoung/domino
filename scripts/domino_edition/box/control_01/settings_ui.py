...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.icon_comboBox.setItemText(2, QCoreApplication.translate("Form", u"arrow", None))
        self.icon_comboBox.setItemText(3, QCoreApplication.translate("Form", u"arrow4", None))
        self.icon_comboBox.setItemText(4, QCoreApplication.translate("Form", u"square", None))
        self.icon_comboBox.setItemText(5, QCoreApplication.translate("Form", u"wave", None))
        self.icon_comboBox.setItemText(6, QCoreApplication.translate("Form", u"circle", None))
        self.icon_comboBox.setItemText(7, QCoreApplication.translate("Form", u"circle3", None))
        self.icon_comboBox.setItemText(8, QCoreApplication.translate("Form", u"locator", None))
        self.icon_comboBox.setItemText(9, QCoreApplication.translate("Form", u"cube", None))
