...
class Spine01Rig(piece.Rig):
    ...
    def attributes(self, context):
        ...
        self.stretch_squash = attribute.add(host,
                                            f"{name}_stretch_squash_enable",
                                            "float",
                                            shortName="stretch_squash_enable",
                                            keyable=True,
                                            minValue=0,
                                            maxValue=1,
                                            defaultValue=1)
        ...
        self.lock_orient_0 = attribute.add(host,
                                           f"{name}_lock_orient_0",
                                           "float",
                                           shortName="lock_orient_0",
                                           keyable=True,
                                           minValue=0,
                                           maxValue=1,
                                           defaultValue=1)
        self.lock_orient_1 = attribute.add(host,
                                           f"{name}_lock_orient_1",
                                           "float",
                                           shortName="lock_orient_1",
                                           keyable=True,
                                           minValue=0,
                                           maxValue=1,
                                           defaultValue=1)
