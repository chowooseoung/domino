...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.stretch_horizontalSlider, 0, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.squash_stretch_pushButton, 3, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.division_spinBox, 2, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.stretch_spinBox, 0, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.squash_spinBox, 1, 3, 1, 1)

        self.verticalSpacer = QSpacerItem(20, 0, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.gridLayout.addItem(self.verticalSpacer, 4, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.squash_horizontalSlider, 1, 2, 1, 1)
