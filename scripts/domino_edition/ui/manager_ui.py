...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.piece_listView = QListView(self.groupBox1)
        self.piece_listView.setObjectName(u"piece_listView")
        self.piece_listView.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.piece_listView.setAlternatingRowColors(True)
        self.piece_listView.setMovement(QListView.Snap)
        self.piece_listView.setWordWrap(False)

        self.verticalLayout_2.addWidget(self.piece_listView)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton.setText(QCoreApplication.translate("Dialog", u"Ext. Shape", None))
