...
################################################################################
## Form generated from reading UI file 'common_component_settings_ui.ui'
##
...
"}")
        ...
        self.select_container_pushButton = QPushButton(self.groupBox_6)
        self.select_container_pushButton.setObjectName(u"select_container_pushButton")
        sizePolicy6.setHeightForWidth(self.select_container_pushButton.sizePolicy().hasHeightForWidth())
        self.select_container_pushButton.setSizePolicy(sizePolicy6)

        self.gridLayout_4.addWidget(self.select_container_pushButton, 0, 2, 2, 1)

        self.container_lineEdit = QLineEdit(self.groupBox_6)
        self.container_lineEdit.setObjectName(u"container_lineEdit")

        self.gridLayout_4.addWidget(self.container_lineEdit, 0, 0, 2, 2)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_6.setTitle(QCoreApplication.translate("Form", u"Container Settings", None))
        self.select_container_pushButton.setText(QCoreApplication.translate("Form", u"Select", None))
