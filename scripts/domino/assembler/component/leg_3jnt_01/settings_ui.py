...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.spring_solver_checkBox = QCheckBox(self.groupBox)
        self.spring_solver_checkBox.setObjectName(u"spring_solver_checkBox")

        self.gridLayout.addWidget(self.spring_solver_checkBox, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.squash_stretch_pushButton, 6, 0, 1, 3)
        ...
        self.division1_spinBox = QSpinBox(self.groupBox)
        self.division1_spinBox.setObjectName(u"division1_spinBox")
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.division1_spinBox.sizePolicy().hasHeightForWidth())
        self.division1_spinBox.setSizePolicy(sizePolicy)
        self.division1_spinBox.setMinimum(1)

        self.horizontalLayout.addWidget(self.division1_spinBox)

        self.division2_spinBox = QSpinBox(self.groupBox)
        self.division2_spinBox.setObjectName(u"division2_spinBox")
        sizePolicy.setHeightForWidth(self.division2_spinBox.sizePolicy().hasHeightForWidth())
        self.division2_spinBox.setSizePolicy(sizePolicy)
        self.division2_spinBox.setMinimum(1)

        self.horizontalLayout.addWidget(self.division2_spinBox)

        self.division3_spinBox = QSpinBox(self.groupBox)
        self.division3_spinBox.setObjectName(u"division3_spinBox")
        sizePolicy.setHeightForWidth(self.division3_spinBox.sizePolicy().hasHeightForWidth())
        self.division3_spinBox.setSizePolicy(sizePolicy)
        self.division3_spinBox.setMinimum(1)

        self.horizontalLayout.addWidget(self.division3_spinBox)
    ...
    def retranslateUi(self, Form):
        ...
        self.spring_solver_checkBox.setText(QCoreApplication.translate("Form", u"Spring Solver", None))
