...
"}")
        ...
        self.notes_textEdit.setTabStopWidth(20)
        ...
        self.run_custom_step_checkBox = QCheckBox(self.custom_step_page)
        self.run_custom_step_checkBox.setObjectName(u"run_custom_step_checkBox")

        self.gridLayout_4.addWidget(self.run_custom_step_checkBox, 0, 0, 1, 1)

        self.custom_step_listWidget = QListWidget(self.custom_step_page)
        QListWidgetItem(self.custom_step_listWidget)
        QListWidgetItem(self.custom_step_listWidget)
        QListWidgetItem(self.custom_step_listWidget)
        QListWidgetItem(self.custom_step_listWidget)
        QListWidgetItem(self.custom_step_listWidget)
        self.custom_step_listWidget.setObjectName(u"custom_step_listWidget")
        self.custom_step_listWidget.setDragEnabled(True)
        self.custom_step_listWidget.setDragDropMode(QAbstractItemView.InternalMove)
        self.custom_step_listWidget.setAlternatingRowColors(True)
        self.custom_step_listWidget.setSelectionMode(QAbstractItemView.ExtendedSelection)

        self.gridLayout_4.addWidget(self.custom_step_listWidget, 2, 0, 7, 1)

        self.custom_step_add_pushButton = QPushButton(self.custom_step_page)
        self.custom_step_add_pushButton.setObjectName(u"custom_step_add_pushButton")

        self.gridLayout_4.addWidget(self.custom_step_add_pushButton, 2, 1, 1, 1)

        self.custom_step_new_pushButton = QPushButton(self.custom_step_page)
        self.custom_step_new_pushButton.setObjectName(u"custom_step_new_pushButton")

        self.gridLayout_4.addWidget(self.custom_step_new_pushButton, 3, 1, 1, 1)

        self.custom_step_edit_pushButton = QPushButton(self.custom_step_page)
        self.custom_step_edit_pushButton.setObjectName(u"custom_step_edit_pushButton")

        self.gridLayout_4.addWidget(self.custom_step_edit_pushButton, 4, 1, 1, 1)

        self.custom_step_remove_pushButton = QPushButton(self.custom_step_page)
        self.custom_step_remove_pushButton.setObjectName(u"custom_step_remove_pushButton")

        self.gridLayout_4.addWidget(self.custom_step_remove_pushButton, 5, 1, 1, 1)

        self.custom_step_run_sel_pushButton = QPushButton(self.custom_step_page)
        self.custom_step_run_sel_pushButton.setObjectName(u"custom_step_run_sel_pushButton")

        self.gridLayout_4.addWidget(self.custom_step_run_sel_pushButton, 6, 1, 1, 1)

        self.custom_step_localizing_pushButton = QPushButton(self.custom_step_page)
        self.custom_step_localizing_pushButton.setObjectName(u"custom_step_localizing_pushButton")

        self.gridLayout_4.addWidget(self.custom_step_localizing_pushButton, 7, 1, 1, 1)
        ...
        self.custom_step_search_lineEdit = QLineEdit(self.custom_step_page)
        self.custom_step_search_lineEdit.setObjectName(u"custom_step_search_lineEdit")

        self.gridLayout_4.addWidget(self.custom_step_search_lineEdit, 1, 0, 1, 2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.run_custom_step_checkBox.setText(QCoreApplication.translate("Dialog", u"Run Custom Step", None))

        __sortingEnabled = self.custom_step_listWidget.isSortingEnabled()
        self.custom_step_listWidget.setSortingEnabled(False)
        ___qlistwidgetitem = self.custom_step_listWidget.item(0)
        ___qlistwidgetitem.setText(QCoreApplication.translate("Dialog", u"objects", None));
        ___qlistwidgetitem1 = self.custom_step_listWidget.item(1)
        ___qlistwidgetitem1.setText(QCoreApplication.translate("Dialog", u"attributes", None));
        ___qlistwidgetitem2 = self.custom_step_listWidget.item(2)
        ___qlistwidgetitem2.setText(QCoreApplication.translate("Dialog", u"operators", None));
        ___qlistwidgetitem3 = self.custom_step_listWidget.item(3)
        ___qlistwidgetitem3.setText(QCoreApplication.translate("Dialog", u"connections", None));
        ___qlistwidgetitem4 = self.custom_step_listWidget.item(4)
        ___qlistwidgetitem4.setText(QCoreApplication.translate("Dialog", u"finalize", None));
        self.custom_step_listWidget.setSortingEnabled(__sortingEnabled)

        self.custom_step_add_pushButton.setText(QCoreApplication.translate("Dialog", u"Add", None))
        self.custom_step_new_pushButton.setText(QCoreApplication.translate("Dialog", u"New", None))
        self.custom_step_edit_pushButton.setText(QCoreApplication.translate("Dialog", u"Edit", None))
        self.custom_step_remove_pushButton.setText(QCoreApplication.translate("Dialog", u"Remove", None))
        self.custom_step_run_sel_pushButton.setText(QCoreApplication.translate("Dialog", u"Run. Sel", None))
        self.custom_step_localizing_pushButton.setText(QCoreApplication.translate("Dialog", u"Localizing", None))
        self.toolBox.setItemText(self.toolBox.indexOf(self.custom_step_page), QCoreApplication.translate("Dialog", u"CustomStep Settings", None))
